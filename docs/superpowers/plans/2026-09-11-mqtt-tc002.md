...
/// exakt — sie entsteht aus demselben Raster —, erlaubt Umlaute und Kleinbuchstaben,
/// die der Geraetefont nicht sauber kann, und laesst die Schriftart frei waehlen.
...
struct SendenView: View {
    ...
    private func senden() {
        ...
        if let icon = gewaehltesIcon, let uri = try? sammlung.datenURI(fuer: icon) {
            frame.bilder = [Bild(datenURI: uri, position: [0, 4])]
        }
