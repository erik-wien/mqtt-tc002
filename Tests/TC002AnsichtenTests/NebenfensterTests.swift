...
final class NebenfensterTests: XCTestCase {
    ...
    /// nur in der Titelleiste (Rückmeldung vom 13.09.2026, Bild 2). Der
    /// Programmname gehört in den Menüeintrag, der das Fenster öffnet, nicht
    /// in den Titel des Fensters selbst.
