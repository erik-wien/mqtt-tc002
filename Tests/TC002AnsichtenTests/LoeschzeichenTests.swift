...
/// angefordert wird, steht hier — und genau das fällt sonst niemandem auf,
/// wenn jemand ein Feld umbaut und die Bindung dabei verliert.
final class LoeschzeichenTests: XCTestCase {
    ...
    /// Gesucht wird der Knopf **in der Zeile**, nicht die „ohne"-Kachel im
    /// Blatt: Die gibt es längst, und sie verlangt erst den Umweg übers Blatt —
    /// genau den soll das Zeichen ersparen. Deshalb hängt die Prüfung am
    /// Zeichen und nicht bloß an `gewaehltesIcon = nil`.
