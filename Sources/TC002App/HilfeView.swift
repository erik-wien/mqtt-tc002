    ...
    var bausteine: [Hilfebaustein] {
        ...
        case .senden:
            return [
                ...
                .absatz("„Großbuchstaben“ gilt anders als Schriftart und Fett auf beiden Wegen gleich und lässt das Eingabefeld selbst unangetastet — umgewandelt wird erst beim Senden bzw. für die Vorschau; auf dem Weg „als Text“ macht das nebenbei aus einem sonst fehlenden „ß“ ein darstellbares „SS“, während „Ä“, „Ö“ und „Ü“ Umlaute bleiben und weiterhin fehlen."),
