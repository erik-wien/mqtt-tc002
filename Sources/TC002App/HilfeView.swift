    ...
    var absaetze: [String] {
        ...
        case .senden:
            return [
                ...
                "Passt der Text nicht in die verfügbare Breite, erscheint eine Warnung darunter; gesendet wird trotzdem, nur abgeschnitten. Das Display ist 52 Pixel breit, der Text beginnt aber eine Spalte vom Rand — ohne Icon bleiben also 51 Pixel, mit Icon 42, weil das Icon die ersten Spalten belegt. Rechts daneben lässt sich ein Icon aus der Sammlung wählen oder „ohne“; die Vorschau zeigt ein gewähltes Icon an derselben Stelle mit, an der die Uhr es zeigt — so sieht man vor dem Senden, ob Icon und Text zusammenpassen.",
