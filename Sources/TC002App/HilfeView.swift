    ...
    var bausteine: [Hilfebaustein] {
        ...
        case .senden:
            return [
                ...
                .absatz("Mitlesen heißt aber: nur, was gesendet wird, solange die App verbunden ist. Ohne aufbewahrte (RETAIN-)Nachrichten liefert MQTT einem frisch verbundenen Abonnenten keinen Rückstand — das ist kein Fehler dieser App, sondern die normale Stille von MQTT 3.1.1 (siehe auch „Wenn nichts erscheint“). Was diese Installation selbst geschickt hat, zeigt der Block nach einem Neustart trotzdem: Dafür merkt sie sich je Platz die Regler und rechnet das Bild daraus neu. Ohne Inhalt bleiben deshalb die Plätze, zu denen es hier nichts zu merken gab — sie zeigen „belegt“, bis dort das nächste Mal etwas gesendet wird."),
        ...
        case .malen:
            return [
                ...
                .ueberschrift("Senden"),
                .absatz("Die fünf Slot-Blöcke stehen auch hier, mit denselben drei Zuständen und demselben Stand der aktiven Uhr wie unter „Senden“ — ein Antippen wählt hier aber nur den Platz: Regler, die sich wiederherstellen ließen, gibt es beim Malen nicht."),
