    ...
    var absaetze: [String] {
        ...
        case .ueberblick:
            return [
                ...
                "Links in der Seitenleiste liegen die fünf Bereiche: „Senden“ für Text und Icon, „Malen“ für ein frei gezeichnetes Bild, „Anzeigen“ für bereits verschickte Inhalte und das Protokoll, „Verbindung“ für Uhren, Broker sowie Seitenwechsel und Scrolltempo der aktiven Uhr, „Icons“ für eigene 8×8-Bildchen.",
                "Was das Gerät selbst kann und wie das Protokoll dahinter aussieht, steht nicht hier, sondern unter „Hilfe → Gerätereferenz“. Diese Hilfe beschreibt nur, was man in der App klickt.",
            ]
        case .verbindung:
            return [
                ...
                "Darunter steht „Einstellungen der aktiven Uhr“ mit zwei Werten. „Seitenwechsel“: wie lange eine Anzeige stehen bleibt, bevor die Uhr zur nächsten blättert — „kein Wechsel“ bedeutet, die erste Anzeige bleibt stehen, egal was sonst ankommt. „Scrolltempo“: wie schnell Text läuft, den die Uhr selbst setzt — das betrifft nur „Senden“ im Weg „vom Gerät setzen“, nicht den selbst gerasterten Weg „als Pixel“; der gültige Wertebereich ist nicht dokumentiert. Beides betrifft immer die gerade aktive Uhr — welche das ist, bestimmt der Radioknopf oben in der Liste. Gelesen wird beim Öffnen des Bereichs direkt von der Uhr über HTTP, geschrieben erst, wenn man selbst etwas wählt; von sich aus ändert die App nichts am Gerät. Lässt sich ein Wert nicht lesen, sagt das ein Hinweisfenster statt stillschweigend einen falschen Stand zu zeigen.",
        ...
        case .senden:
            return [
                ...
                "Oben steht die Wahl des Wegs, auf dem der Text zur Uhr kommt — ein echter Zielkonflikt, keine beliebige Einstellung. „Als Pixel“ rastert selbst: Umlaute und Satzzeichen gehen, jede installierte Schriftart und Fett stehen zur Wahl, die Vorschau stimmt exakt — aber der Text muss in die verfügbare Breite passen, sonst wird er abgeschnitten. „Vom Gerät setzen“ schickt den Text stattdessen unverändert an die Uhr, die ihn selbst in ihrer eingebauten Schrift setzt: langer Text läuft dafür durch, das Tempo bestimmt „Scrolltempo“ unter „Verbindung“ — aber die Gerätschrift kennt keine Umlaute und kaum Satzzeichen (siehe „Wenn nichts erscheint“), und Schriftart sowie Fett gelten hier nicht, die Formatleiste sperrt sie deshalb. Größe, Farbe und Ausrichtung gelten in beiden Wegen.",
                ...
                "Im Weg „als Pixel“ wird der Text nicht als Zeichenkette verschickt, sondern selbst in Pixel gerastert und als Zeichenflächen übertragen. Grund: Die eingebaute Schrift der Uhr kennt keine Umlaute und kaum Satzzeichen. Mit eigenem Rastern gehen „ä“, „ö“, „ü“ und „ß“ trotzdem, und die Vorschau links zeigt genau das Bild, das auch gesendet wird — sie entsteht aus demselben Pixelfeld.",
                "Oberhalb des Textfelds sitzt die Formatleiste, wie in einem Textprogramm: Schriftart, Größe (6 bis 16 Pixel), ein Fett-Knopf sowie zwei Gruppen aus je drei Symbolknöpfen für die waagrechte und die senkrechte Ausrichtung — welche Richtung ein Knopf setzt, sagt sein Einblendtext beim Verweilen mit der Maus. Bei 16 Pixeln Displayhöhe eignen sich schmale, dicktengleiche Schriften am besten — die meisten proportionalen Schriften wirken bei dieser Größe eher wie ein Brei aus Pixeln. Im Weg „vom Gerät setzen“ sind Schriftart und Fett-Knopf gesperrt, weil die Uhr ihre eigene Schrift setzt; Größe, Ausrichtung und Farbe gelten dort unverändert weiter. Die Uhr selbst kennt für ihre eigene Schrift Felder wie Ausrichtung und Zeilenhöhe (siehe Hilfe → Gerätereferenz, §4.3) — im Weg „als Pixel“ benutzt diese App sie nicht, weil sie den Text ja bereits selbst gerastert an die Uhr schickt und diese Felder nur für unrasterten Gerätetext gelten; im Weg „vom Gerät setzen“ sind sie es, die die Ausrichtungsknöpfe und der Größe-Steller ansprechen.",
                "Passt der Text im Weg „als Pixel“ nicht in die verfügbare Breite, erscheint eine Warnung darunter; gesendet wird trotzdem, nur abgeschnitten, und die Warnung berücksichtigt auch den fetten Schnitt. Ohne Icon ist die verfügbare Breite die vollen 52 Pixel des Displays, mit Icon 42, weil das Icon die ersten zehn Spalten belegt — die waagrechten Ausrichtungsknöpfe richten den Text innerhalb dieser Breite aus, die senkrechten innerhalb der 16 Zeilen, gerechnet über die tatsächlich gesetzte Höhe, nicht die Schriftgröße. Im Weg „vom Gerät setzen“ entfällt diese Warnung — dort steht stattdessen der Hinweis, dass langer Text am Gerät durchläuft und dass die Vorschau nur eine Annäherung ist: Sie zeigt weiterhin unsere eigene Rasterung, nicht das, was die Uhr mit ihrer Schrift tatsächlich setzt, und vor allem fehlen darin Umlaute.",
                "Neben dem Textfeld steht ein Knopf, der ohne Wahl „Icon wählen…“ heißt und mit Wahl Vorschaubild und Namen des Icons zeigt — in beiden Fällen ein Druck, der ein Blatt mit Suchfeld und Raster öffnet, dazu ein Eintrag „ohne“, um die Wahl im Blatt loszuwerden, und „Schließen“ zum Beenden. Ist ein Icon gewählt, steht daneben ein kleiner Knopf zum Entfernen, ohne das Blatt erst öffnen zu müssen. Die Vorschau darunter zeigt ein gewähltes Icon an derselben Stelle mit, an der die Uhr es zeigt — so sieht man vor dem Senden, ob Icon und Text zusammenpassen. Ist das Icon animiert, spielt die Vorschau es probeweise in Schleife ab; ob die Uhr selbst ein animiertes Icon abspielt, zeigt das nicht und ist am Gerät noch nicht nachgeprüft (Hilfe → Gerätereferenz, §4.2).",
        ...
        case .icons:
            return [
                ...
                "Mitgelieferte Icons liegen im App-Paket und lassen sich nicht löschen — ein Versuch meldet das. Selbst gemalte liegen unter `~/Library/Application Support/MQTT-TC002/Icons`, erreichbar auch über „Ablage → Eigene Icons im Finder zeigen“.",
        ...
        case .fehlersuche:
            return [
                ...
                "Blättert die Uhr nicht zur neuen Anzeige, obwohl mehrere angelegt sind: „Seitenwechsel“ unter „Verbindung“ steht vermutlich auf „kein Wechsel“. Fehlen einzelne Zeichen, insbesondere Umlaute: Bei „Senden“ steht der Weg vermutlich auf „vom Gerät setzen“ — dort setzt die Uhr den Text mit ihrer eigenen, umlautlosen Schrift. Der Weg „als Pixel“ rastert stattdessen selbst und kennt dieses Problem nicht.",
            ]
        }
    }
}
