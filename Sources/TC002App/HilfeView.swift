    ...
    var absaetze: [String] {
        ...
        case .senden:
            return [
                ...
                "Über dem Text lassen sich Schriftart, Größe (6 bis 16 Pixel), Fett sowie die waagrechte und senkrechte Ausrichtung einstellen. Bei 16 Pixeln Displayhöhe eignen sich schmale, dicktengleiche Schriften am besten — die meisten proportionalen Schriften wirken bei dieser Größe eher wie ein Brei aus Pixeln. Die Uhr selbst kennt für ihre eigene Schrift Felder wie Ausrichtung und Zeilenhöhe (siehe `docs/tc002-protokoll.md` §4.3) — diese App benutzt sie nicht, weil sie den Text ja bereits selbst gerastert an die Uhr schickt und diese Felder nur für unrasterten Gerätetext gelten.",
                "Passt der Text nicht in die verfügbare Breite, erscheint eine Warnung darunter; gesendet wird trotzdem, nur abgeschnitten, und die Warnung berücksichtigt auch den fetten Schnitt. Ohne Icon ist die verfügbare Breite die vollen 52 Pixel des Displays, mit Icon 42, weil das Icon die ersten zehn Spalten belegt — „Waagrecht“ richtet den Text innerhalb dieser Breite aus, „Senkrecht“ innerhalb der 16 Zeilen, gerechnet über die tatsächlich gesetzte Höhe, nicht die Schriftgröße. Rechts daneben lässt sich ein Icon aus der Sammlung wählen oder „ohne“; das Suchfeld darüber filtert nach Name und Nummer, die Liste selbst wächst mit der Fensterhöhe. Die Vorschau zeigt ein gewähltes Icon an derselben Stelle mit, an der die Uhr es zeigt — so sieht man vor dem Senden, ob Icon und Text zusammenpassen.",
