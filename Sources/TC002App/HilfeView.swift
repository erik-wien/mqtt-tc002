...
private enum Abschnitt: String, CaseIterable, Identifiable {
    ...
    var absaetze: [String] {
        ...
        case .icons:
            return [
                "Der Bereich „Icons“ malt eigene 8×8-Bildchen, die danach unter „Senden“ neben dem Text zur Wahl stehen. Der Systemfarbwähler „Farbe“ unter der Malfläche stellt die Farbe ein, „Radieren“ entfernt einzelne Pixel, „Alles löschen“ die ganze Fläche.",
                "„Sichern“ legt das gemalte Icon unter der eingetragenen „Nummer“ und dem „Name“ ab — die Nummer ist zugleich der Dateiname und muss deshalb eindeutig sein, der Name ist frei; die Eingabetaste löst „Sichern“ aus. Rechts in „Vorhandene Icons“ stehen alle verfügbaren Icons, durch das Suchfeld nach Name oder Nummer eingrenzbar; ein Klick lädt eines zurück in die Malfläche, das Kontextmenü bietet „Öffnen“ und „Löschen“.",
