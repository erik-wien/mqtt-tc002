    ...
    var bausteine: [Hilfebaustein] {
        ...
        case .senden:
            return [
                ...
                .absatz("Mitlesen heißt aber: nur, was gesendet wird, solange die App verbunden ist. Ohne aufbewahrte (RETAIN-)Nachrichten liefert MQTT einem frisch verbundenen Abonnenten keinen Rückstand — das ist kein Fehler dieser App, sondern die normale Stille von MQTT 3.1.1 (siehe auch „Wenn nichts erscheint“). Was diese Installation unter „Senden“ selbst geschickt hat, zeigt der Block nach einem Neustart trotzdem: Dafür merkt sie sich je Platz die Regler und rechnet das Bild daraus neu. Für Gemaltes gilt das nicht: Ein gemaltes Bild hat keine Regler, es wird nicht gemerkt, und eine Sendung aus dem Malbereich wirft obendrein weg, was zu diesem Platz gemerkt war. Ohne Inhalt bleiben deshalb die Plätze, zu denen es hier nichts zu merken gab — sie zeigen „belegt“, bis dort das nächste Mal etwas mitgelesen oder etwas Merkbares gesendet wird."),
                ...
                .absatz("Der Papierkorb rechts neben der Platzwahl löscht den gewählten Platz auf den gewählten Uhren — dasselbe, was unter „Verlauf“ der Knopf „Löschen“ tut, nur dort, wo man den Platz gerade in der Hand hat. Er ist gesperrt, solange der Platz leer ist. Im Malbereich sitzt er ebenso in der unteren Zeile neben den fünf Blöcken; „Leeren“ steht dagegen oben in der Werkzeugzeile. Die beiden meinen Verschiedenes: „Leeren“ macht die Malfläche leer, der Papierkorb löscht die Anzeige auf der Uhr."),
