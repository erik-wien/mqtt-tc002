    ...
    var bausteine: [Hilfebaustein] {
        ...
        case .editor:
            return [
                    ...
                    .absatz("Der Bereich „Icons“ malt Pixel. Was dabei herauskommt, entscheidet allein die Größe der Leinwand: Ein 8×8 ist das kanonische LaMetric-Icon mit Nummer, ein 16×16 ein Icon ohne, und ein 16×52 ist die ganze Anzeige."),
                    ...
                    .absatz("„Finder …“ — am iPad „Dateien …“ — nimmt eine GIF-, PNG- oder JPEG-Datei von der Platte auf — und zwar in **ihrer eigenen** Größe: ein 8×8 als 8×8, ein 16×16 als 16×16, ein 16×52 als Anzeige. Der Editor stellt sich auf die Datei ein, nicht umgekehrt; die Meldung nennt deshalb den Bestand, in dem sie gelandet ist. Ein animiertes GIF behält dabei alle seine Einzelbilder."),
