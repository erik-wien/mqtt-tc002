    ...
    var bausteine: [Hilfebaustein] {
        ...
        case .editor:
            return [
                    ...
                    .absatz("Er beginnt mit der **Übersicht**: alles, was im Bestand liegt, nach Größe gruppiert im Hauptfenster. Ein Suchfeld grenzt nach Name und Nummer ein, daneben blendet ein Schalter auf bewegte Stücke ein. Ein Druck auf ein Stück holt es auf die Leinwand; in der Werkzeugleiste steht dort nur „Neu“ für ein leeres Blatt."),
                    ...
                    .absatz("„Ungesichert“ heißt hier: Was auf der Leinwand steht, weicht von dem ab, was im Bestand liegt — nicht, dass es beim Beenden verloren ginge; das zuletzt Gemalte übersteht einen Neustart ohnehin. Eine nie gesicherte Zeichnung ist deshalb ungesichert, ein eben geöffnetes Bild nicht, und wer seinen Strich mit „Rückgängig“ zurücknimmt, steht wieder auf dem gesicherten Stand. Danach fragt, was die Leinwand verwirft: „Neu“, ein Größenwechsel und ein geladenes Bild. Ein Stück aus der Übersicht zu öffnen fragt nicht — dort ist der Druck darauf die Ansage, dass man es will. Name und Nummer zählen ohnehin nicht mit; sie sind in zwei Anschlägen wieder eingetippt."),
                    .absatz("Gesichert wird über den Haken rechts über der Leinwand; er legt alle Einzelbilder auf einmal ab. Bei einem neuen Stück und bei jedem nummerngeführten Icon fragt vorher ein Blatt nach Nummer und Namen und sagt, was es ersetzen würde — so ersetzt ein bearbeitetes LaMetric-Icon sein Vorbild nicht stillschweigend. Das Kreuz links daneben führt zurück zur Übersicht, ohne zu sichern; das zuletzt Gemalte bleibt dabei erhalten. Bei 8×8 gilt für die Nummer: Sie ist der Dateiname und zugleich die LaMetric-Nummer und muss eindeutig sein. Bei 52×16 gibt es ebenfalls eine — die Werknummer, die Ulanzi für seine „Pixel Art 52×16“ vergibt —, aber sie ist **wahlfrei** und benennt die Datei nicht: Dort heißt die Datei weiter nach dem Namen, und derselbe Name ersetzt das Vorhandene. Bei 16×16 gibt es keine Nummer; diese Größe ist nicht kanonisch, sie stammt von uns. Nachladen lässt sich von Ulanzi nichts — eine Adresse, die eine fertige 52×16-Datei liefert, gibt es dort nicht."),
                    .absatz("„Neu“ in der Werkzeugleiste der Übersicht beginnt von vorn: Leinwand, Einzelbilder, Verzögerung, Name und Nummer. Steht noch etwas Ungesichertes da, fragt eine Rückfrage vorher nach."),
                    ...
                    .absatz("Bei 8×8 lässt sich eine Nummer von developer.lametric.com eintragen und mit dem Pfeilzeichen daneben holen — die Eingabetaste im Feld tut dasselbe. Das geholte Icon kommt danach auf die Leinwand, mit derselben Rückfrage wie eine geöffnete Datei. Eine unbekannte Nummer ergibt eine verständliche Meldung und macht sonst nichts kaputt. Der Verweis „LaMetric Icon Gallery“ darunter öffnet die Seite in einem Blatt, mit dem Nummernfeld darunter: Wer dort ein Icon findet, trägt seine Nummer ein und holt es, ohne die App zu verlassen. „Grundschatz wiederherstellen“ ergänzt nur, was im eigenen Ordner fehlt, und lässt Vorhandenes unangetastet; die Meldung danach nennt die Anzahl."),
                    .absatz("„Finder …“ — am iPad „Dateien …“ — nimmt eine GIF-, PNG- oder JPEG-Datei von der Platte auf — und zwar in **ihrer eigenen** Größe: ein 8×8 als 8×8, ein 16×16 als 16×16, ein 52×16 als Anzeige. Der Editor stellt sich auf die Datei ein, nicht umgekehrt; die Meldung nennt deshalb den Bestand, in dem sie gelandet ist. Ein animiertes GIF behält dabei alle seine Einzelbilder."),
                    .absatz("Jede andere Größe wird **abgelehnt**, mit Begründung („Das Bild ist 32×32. Aufgenommen werden 8×8, 16×16 und 52×16.“). Bis zum 13.09.2026 wurde stattdessen stillschweigend auf die gerade eingestellte Größe heruntergerechnet — ein 16×16 landete als 8×8, wenn der Editor auf 8×8 stand. Verkleinern zerstört, und wer es nicht gewollt hat, sah es nicht."),
