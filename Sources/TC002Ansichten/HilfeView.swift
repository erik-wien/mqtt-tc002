    ...
    var bausteine: [Hilfebaustein] {
        ...
        case .senden:
            return [
                ...
                + [
                    ...
                    .absatz("Die Eingabetaste schickt. Am rechten Rand des Feldes steht dafür ein blauer runder Knopf mit Pfeil, den du ebenso anklicken kannst; er erscheint, sobald etwas im Feld steht, und weicht während des Sendens einem Fortschrittsdreher. Ist die Anzeige hinaus, wird er eine Sekunde lang grün und zeigt einen Haken — die Rückmeldung sitzt da, wo du gedrückt hast. Links daneben leert ein ⊗ das Feld. Auf dem iPad heißt die Eingabetaste der Bildschirmtastatur „Senden“."),
                    .absatz("Geht dabei etwas schief — die Uhr nicht erreichbar, die Uhr weist die Anzeige ab, falsches Broker-Kennwort, Broker nicht erreichbar, Zeitüberschreitung, unlesbare Icondatei —, erscheint ein Hinweisfenster mit dem Grund. Bei mehreren Zieluhren steht dort eine Zeile je betroffener Uhr; die übrigen werden trotzdem beliefert."),
        ...
        case .editor:
            return [
                    ...
                    .ueberschrift("Malen"),
                    .absatz("Gemalt wird mit gedrückter Maustaste oder mit dem Finger. In der Karte „Werkzeug“ des Inspektors steht die Farbe und daneben die Wahl zwischen drei Werkzeugen: Der **Stift** malt, der **Radierer** nimmt weg, der **Eimer** füllt eine Fläche. Ganz unten im Reiter „Malen“ steht „Alles löschen“; es leert das gerade bearbeitete Einzelbild — nicht die anderen — und „Rückgängig“ holt es zurück."),
                    .absatz("Der Eimer färbt die zusammenhängende Fläche gleicher Farbe unter dem angetippten Punkt um, nicht das ganze Bild. Er läuft dabei über die vier Nachbarn und nicht über Eck — eine diagonal gemalte Linie ist also eine Grenze. Durchsichtig zählt als Farbe: Der leere Untergrund eines frischen Icons lässt sich füllen. Wegnehmen kann der Eimer nichts, dafür fährst du mit dem Radierer darüber. Und er wirkt dort, wo die Berührung beginnt, und nur einmal; Ziehen färbt nicht weiter."),
                    ...
                    .ueberschrift("Umformen"),
                    .absatz("Die Karte „Umformen“ bewegt die ganze Grafik. Das Kreuz schiebt sie um ein Pixel; was am Rand hinausgeschoben wird, kommt gegenüber wieder herein, statt abgeschnitten zu werden — der Gegenpfeil nimmt damit jeden Schritt genau zurück. Darunter drehen zwei Knöpfe nach links und rechts, zwei weitere spiegeln waagrecht und senkrecht."),
                    .absatz("Gedreht wird nur quadratisch. Auf einer 52 × 16-Anzeige stehen die beiden Drehknöpfe gesperrt da, und der Fuß der Karte sagt, warum: Gedreht wäre die Anzeige 16 × 52 hoch, und diese Größe zeigt keine Uhr. Beschneiden käme nicht in Frage — 36 Spalten wären weg, und nichts holte sie zurück. Spiegeln geht in jeder Größe."),
                    .absatz("Die letzte Zeile der Karte — „Alle Bilder“ oder „Nur dieses“ — gilt für Schieben, Drehen und Spiegeln zugleich und steht nur da, wenn es mehr als ein Einzelbild gibt. Das eine richtet die ganze Animation aus, das andere versetzt ein Bild gegen die übrigen."),
                    ...
                    .absatz("Ein Strich ist ein Schritt, nicht ein Pixel: Wer mit dem Finger über zwanzig Kästchen fährt, macht ihn mit einem Druck wieder rückgängig. Je ein Schritt sind außerdem „Alles löschen“, jede Füllung mit dem Eimer, jede Umformung — schieben, drehen, spiegeln —, ein Einzelbild anhängen, verdoppeln, entfernen oder umsortieren, und ein Größenwechsel. Farbwahl, Werkzeug, Bildwahl, Verzögerung, Name und Nummer ändern nichts an der Zeichnung und sind deshalb keine Schritte."),
                    ...
                    .absatz("Ein Bild kann aus mehreren Einzelbildern bestehen; das ergibt beim Sichern ein animiertes GIF, das in Schleife läuft. Der Streifen unter der Leinwand zeigt alle, das gerade bearbeitete hervorgehoben; ein Klick darauf schaltet die Leinwand um. Er steht nur da, wenn es mehr als ein Einzelbild gibt. „Frame anhängen“ im Reiter „Animation“ hängt ein leeres an und schaltet die Leinwand gleich darauf um — Frame ist das englische Wort für Einzelbild."),
                    ...
                    .absatz("Die Nummer ist die LaMetric-Nummer: Unter ihr wird ein Icon angesprochen, auch aus einem Kurzbefehl. Wie sie benutzt wird, hängt an der Größe."),
                    .punkte([
                        "**8 × 8** — die Nummer ist zugleich der Dateiname und muss deshalb eindeutig sein.",
                        "**16 × 16** — keine Nummer. Diese Größe ist nicht kanonisch, sie stammt von uns.",
                        "**52 × 16** — eine Nummer gibt es, die Werknummer von Ulanzi für seine „Pixel Art 52 × 16“. Sie ist wahlfrei und benennt die Datei nicht: Die heißt nach dem Namen, und derselbe Name ersetzt das Vorhandene.",
                    ]),
                    .absatz("Nachladen lässt sich von Ulanzi nichts — eine Adresse, die eine fertige 52 × 16-Datei liefert, gibt es dort nicht."),
