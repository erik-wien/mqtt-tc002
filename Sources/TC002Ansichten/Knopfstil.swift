...
///
/// Warum ueberhaupt ein eigener Ort: Die Vorgabe (`.automatic`) sieht auf den
/// beiden Geraeten verschieden aus: Am Mac zeichnet sie in einer `Form` einen
/// gerahmten Knopf, unter iOS und iPadOS blosse Schrift in der Akzentfarbe.
/// Ein Befehl sah dort damit aus wie ein Verweis — „Radieren" wie ein Link.
/// Drei Aufrufe an einer Stelle statt hundert verstreuter `.buttonStyle`-
/// Zeilen halten das zusammen.
///
...
/// ist `.tint(.primary)`, aber nur ausserhalb von macOS: Dort faerbt ein Tint
/// auch die Flaeche, und aus dem gewohnten Systemknopf wuerde ein dunkler
