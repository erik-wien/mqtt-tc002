...
public enum HilfeInhalt {
    ...
    public static let uhrAbfragen: [Hilfebaustein] = [
        ...
        .absatz("Zwei Uhren dürfen im MQTT-Betrieb nicht dasselbe Präfix führen: Über MQTT **ist** das Präfix die Adresse. Was an die eine geht, zeigt auch die andere, beide melden ihren Zustand auf demselben Thema, und die App kann von da an nicht mehr auseinanderhalten, welche was sagt. Die Einstellungen sagen es, wenn zwei sich eines teilen; geändert wird es an der Uhr selbst, über „Konfigurieren“."),
