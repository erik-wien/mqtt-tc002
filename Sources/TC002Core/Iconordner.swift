...
public enum Iconordner {
    ...
    /// nachsehen zu muessen, was sie ist, und den vorhandenen Bestand zu
    /// veraendern: Eine aeltere Fassung der App liest `Icons/` weiterhin als
    /// 8×8 und rechnete jedes 16×16 darin stillschweigend herunter. Der neue
    /// Ordner bleibt einer aelteren Fassung dagegen schlicht unsichtbar.
